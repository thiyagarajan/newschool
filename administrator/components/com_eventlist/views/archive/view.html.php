...
class EventListViewArchive extends JView {
	...
	function display($tpl = null)
	{
		...
		//get vars
		$filter_order		= $app->getUserStateFromRequest( $option.'.archive.filter_order', 'filter_order', 'a.dates', 'cmd' );
		$filter_order_Dir	= $app->getUserStateFromRequest( $option.'.archive.filter_order_Dir',	'filter_order_Dir',	'', 'word' );
		$filter 			= $app->getUserStateFromRequest( $option.'.archive.filter', 'filter', '', 'int' );
