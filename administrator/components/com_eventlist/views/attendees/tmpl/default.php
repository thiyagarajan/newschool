	...
	<table class="adminlist" cellspacing="1">
		...
		<tbody>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td><?php echo $row->uip == 'COM_EVENTLIST_DISABLED' ? JText::_( 'COM_EVENTLIST_DISABLED' ) : $row->uip; ?></td>
				<td><?php echo JHTML::Date( $row->uregdate, JText::_( 'DATE_FORMAT_LC2' ) ); ?></td>
				<td><?php echo $row->uid; ?></td>
				<td><a href="javascript: void(0);" onclick="return listItemTask('cb<?php echo $i;?>','remove')"><img src="components/com_eventlist/assets/images/publish_r.png" width="16" height="16" border="0" alt="Delete" /></a></td>
			</tr>
			<?php $k = 1 - $k;  } ?>
		</tbody>
