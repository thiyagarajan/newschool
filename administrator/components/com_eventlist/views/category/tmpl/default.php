...
Joomla.submitbutton = function(pressbutton)
{
	...
	if (form.catname.value == ""){
		alert( "<?php echo JText::_( 'COM_EVENTLIST_CATEGORY' ); ?>" );
	} else {
		...
		<tr>
			...
			<table>
				...
				<tr>
					...
					<td>
						<script language="javascript" type="text/javascript">
						var jmediapath ="<?php echo  JURI::root().JComponentHelper::getParams('com_media')->get('file_path', 'images'); ?>";
						if (document.forms[0].image.options.value!=''){
							jsimg= jmediapath + '/eventlist/categories/' + getSelectedValue( 'adminForm', 'image' );
						} else {
							jsimg='../media/system/images/blank.png';
						}
