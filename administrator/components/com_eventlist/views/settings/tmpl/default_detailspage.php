	          			...
	          			<td width="300" class="key">
       					...
       					<td valign="top">
							...
							<select name="showmapserv" size="1" class="inputbox" onChange="changemapMode()">
  								...
  								<option value="1"<?php if ($this->elsettings->showmapserv == 1) { ?> selected="selected"<?php } ?>><?php echo JText::_( 'COM_EVENTLIST_MAP24' ); ?></option>
  								<option value="2"<?php if ($this->elsettings->showmapserv == 2) { ?> selected="selected"<?php } ?>><?php echo JText::_( 'COM_EVENTLIST_GOOGLEMAP' ); ?></option>
							</select>
       	 				</td>
      				</tr>
					<tr id="map24"<?php if ($mode != 1) echo ' style="display:none"'; ?>>
	          			<td width="300" class="key">
							<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_EVENTLIST_REGISTER_MAP24' ); ?>::<?php echo JText::_('COM_EVENTLIST_REGISTER_MAP24_TIP'); ?>">
								<?php echo JText::_( 'COM_EVENTLIST_REGISTER_MAP24' ); ?>
							</span>
						</td>
       					<td valign="top">
      				...
      				<tr id="gapikey"<?php if ($mode != 2) echo ' style="display:none"'; ?>>
	          			<td width="300" class="key">
							<span class="editlinktip hasTip" title="<?php echo JText::_( 'COM_EVENTLIST_GOOGLE_MAP_KEY' ); ?>::<?php echo JText::_('COM_EVENTLIST_GOOGLE_MAP_KEY_TIP'); ?>">
								<?php echo JText::_( 'COM_EVENTLIST_GOOGLE_MAP_KEY' ); ?>
							</span>
						</td>
       					<td valign="top">
          					<input type="text" name="gmapkey" value="<?php echo $this->elsettings->gmapkey; ?>" size="25" maxlength="255" />
       	 					<a href="http://www.google.com/apis/maps/signup.html" target="_blank"><?php echo JText::_( 'COM_EVENTLIST_REQUEST_MAP_KEY' ); ?></a>
						</td>
      				</tr>
				</tbody>
			</table>
