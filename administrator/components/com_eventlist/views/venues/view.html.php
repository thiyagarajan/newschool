...
class EventListViewVenues extends JView {
	...
	function display($tpl = null)
	{
		...
		//get vars
		$filter_order		= $app->getUserStateFromRequest( $option.'.venues.filter_order', 'filter_order', 'l.ordering', 'cmd' );
		$filter_order_Dir	= $app->getUserStateFromRequest( $option.'.venues.filter_order_Dir', 'filter_order_Dir', '', 'word' );
		$filter_state 		= $app->getUserStateFromRequest( $option.'.venues.filter_state', 'filter_state', '*', 'word' );
		$filter 			= $app->getUserStateFromRequest( $option.'.venues.filter', 'filter', '', 'int' );
