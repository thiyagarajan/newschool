...
/**
 * SubsStatistic class, defining a statistic on user subscription to a newsletter.
 *
 * @package		JINC
 * @subpackage          Graphics
 * @since		0.6
 */
class SubsStatistic extends NewsletterStatistic {
    /**
     * SubsStatistic constructor
     *
     * @param TimeLine $timeline Statistic time line
     */
    function SubsStatistic($timeline) {
        parent::NewsletterStatistic($timeline);
    }

    /**
     * It performs the Statistic about user subscription to a newsletter.
     */
    function perform() {
        $this->clean();
