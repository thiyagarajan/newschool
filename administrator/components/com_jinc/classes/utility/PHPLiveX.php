 ...
 */
     ...
     * @param Array $functions: array of function names to ajaxify
     */
    function Ajaxify($functions = array()) {
...
<script type="text/javascript">
     ...
     */
    function AjaxifyObjectMethods($methods = array()) {
     ...
     */
    function AjaxifyObjects($objects = array()) {
			...
			if(asynchronous){
				...
				if(funcName){
                        ...
                        var PLX_Repeats = {};
                                             ...
                                             */
                                            function Run($includeJS = true, $filepath = "phplivex.js") {
                                                if($this->Ran) return;
                                                $this->Ran = true;
