    ...
    <table class="adminlist">
        <thead>
            <tr>
                ...
                <th width="30%">
                    <?php echo JHtml::_('grid.sort', 'COM_JINC_LIST_TITLE', 'title', $listDirn, $listOrder); ?>
                </th>
                <th width="30%">
                    <?php echo JText::_('COM_JINC_BDESC'); ?>
                </th>
        ...
        <tbody>
            ...
            ?>
                    ...
                    <td>
                        <a href="<?php echo JRoute::_('index.php?option=com_jinc&task=notice.edit&id=' . $this->escape($item->id)); ?>">
