	...
	function submitbutton( pressbutton ) {
     ...
     <?php endif; ?>
		...
		if ( venue.length==0 ) {
   			...
   			alert("<?php echo JText::_( 'COM_EVENTLIST_ERROR_ADD_ZIP', true ); ?>");
   			form.plz.focus();
   			return false;
		 ...
		 <p class="clear"></p>
      	...
      	<fieldset class="el_fldst_address">
            ...
            <div class="el_map floattext">
                ...
                <input type="radio" name="map" id="map0" onchange="removerequired();" value="0" checked="checked" class="inputbox" />
                <br class="clear" />
              	<label for="map1"><?php echo JText::_( 'COM_EVENTLIST_YES' ); ?></label>
              	<input type="radio" name="map" id="map1" onchange="addrequired();" value="1"  class="inputbox" />
            </div>
            <?php endif; ?>
