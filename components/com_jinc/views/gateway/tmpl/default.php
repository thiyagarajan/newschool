...
if (isset($this->title)) {
    echo '<div class="jinc_msg_title">' . JText::_($this->title) . '</div>';
}
if (isset($this->subtitle))
    echo '<div class="jinc_msg_subtitle">' . $this->subtitle . '</div>';

$msg = isset($this->msg) ? $this->msg : '';
echo '<div class="jinc_msg_text">' . JText::_($this->msg) . '</div>';
?>