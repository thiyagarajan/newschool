...
class modtoppanelHelper
{
	function renderItem(&$item, &$params, &$access)
	{
		...
		require(JModuleHelper::getLayoutPath('mod_toppanel', '_item'));
	}
	...
	function correctPng($image) {
		return modtoppanelHelper::isIe(6) ? "filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" . $image . "', sizingMethod='scale');background: none;" : "";
	}
}