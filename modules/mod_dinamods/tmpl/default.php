...
<div class="cpnl-l" style="templates/<?php echo $ATconfig->template ?>/images/toppanel_left.png"></div>
<div class="cpnl-m"><?php echo $cpnl_label ?></div>
<div class="cpnl-r" style="templates/<?php echo $ATconfig->template ?>/images/toppanel_right.png"></div>
</div>
</div>
