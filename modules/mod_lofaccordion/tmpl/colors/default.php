...
?>
<div  class="lof-accordion-color" id="lof-accordion<?php echo $module->id;?>">
	<?php foreach( $list as $key => $row ) : //echo '<pre>'.print_r( $row,1 ); die; ?>
    <div class="lof-toggler lof-toggler-<?php echo $module->id;?>">
    	<div class="lof-inner" id="lof-header<?php echo $key+1; ?>">
            <div class="lof-arrow">&nbsp;</div>
            <div class="lof-title"><?php echo $row->subtitle;?></div>
        </div>
     </div>
